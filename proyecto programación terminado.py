...
preguntas=["Un auto estrelló la fachada la empresa(-400).\nPresiona a,b,c o d para seguir.","Te han llegado varias propuestas para mejorar la producción de tus dispositivos y tienes que decidir si quieres o no aplicar alguna de estas propuestas.\na) No aplicar ninguna propuesta.\nb) Modernizar maquinaria con nuevas tecnologías (costo de inversión 2000) ( + 20 producción por máquina) ( + 60 compra de máquinas).\nc) Cambiar toda la maquinaria por nueva y más productora (costo de inversión 1100 por máquina) (+100 producción por máquina) (+ 300 por compra de máquina) (+ 3 empleados más por máquina).\nd) Añadir a las máquina un nuevo dispositivo capaz de aumentar producción (costo de inversión 50 por máquina) (+ 10 de producción por máquina) (+50 por compra de máquinas)","Tus empleados están pidiendo un aumento de paga debido a que piensan que están sobrecargados, un estudio que realizaste demuestra que en efecto tienen sobrecarga, ¿que vas a hacer?.\na) Nada, seguir como vamos.\nb) aumentar el salario a los empleados en 2.\nc) aumentar el salario a los empleados en 5.\nd) Dar 1 hora más de descanso a los empleados.","Tu esposa termino contigo y se llevó un tercio de tus ganancias totales.\nPresiona a,b,c o d para seguir.","La planta de energía de la empresa se averió y si no la arreglas no se podrá continuar con la producción.(-4000).\nPresiona a,b,c o d para seguir.","¿Quieres cambiar las máquinas a operar con tres empleados más? su inversión es 1200 y aumenta tu producción de máquina en 20.\n a) Sí \nb) No\nc) No \nd) No","Has sido estafado con dos máquinas, el reemplazo te salió caro(-3000).\nPresiona a,b,c o d para seguir."]
...
def pregrep():
  print("Pon el numero de maquinas quieres comprar, si no quieres comprar ninguna pon 0")
